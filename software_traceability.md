...
| F-MER-006   | Xem log sự kiện                    | UC-MER-005     | -                         |
...
| F-SYS-003   | Giỏ chỉ dành cho người đã đăng nhập      | UC-CUS-002     | -                      |
...
| Requirement | Mô tả rút gọn                                 | Use Case Chính | Use Case Extension |
|-------------|-----------------------------------------------|----------------|--------------------|
| NF-SYS-001  | Mật khẩu hash & không lộ trên log             | UC-GEN-001     | UC-MER-005         |
| NF-SYS-002  | Kết nối an toàn cho thao tác nhạy cảm         | UC-GEN-002     | UC-MER-005         |
...
2. Khi thêm tính năng mới, cập nhật cả hai chiều bảng truy vết và xác nhận không tạo UC trùng lặp.
3. Bổ sung luồng chính/ngoại lệ chi tiết (main/alternate flows) cho các UC quan trọng.
